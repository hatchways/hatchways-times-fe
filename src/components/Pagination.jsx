    ...
    >
      <li className="paginationItem">
        <button
          ...
          onClick={onPrevious}
          disabled={currentPage-1 > 0 ? false : true} // change this line to disable a button.
        >
          <ChevronLeftIcon />
        </button>
      </li>
      ...
      <li className="paginationItem">
        <button
          ...
          onClick={onNext}
          disabled={currentPage + 1 <= Math.ceil(totalCount/pageSize) ? false : true} // change this line to disable a button.
        >
          <ChevronRightIcon />
        </button>
      </li>
